...
'''
all_data_csv_path = 'data/20230101_combined_news_and_video_classified.csv'
...
CUDA_VISIBLE_DEVICES=2 python train_bert_firstclass.py    
'''
if __name__ == '__main__':
    '''
    设置模型保存地址
    '''
    ckpt_path = os.path.join(os.getcwd(),'save_bert_firstclass_models','curr_ckpt')
    best_model_path = os.path.join(os.getcwd(),'save_bert_firstclass_models','best_model.pt')
